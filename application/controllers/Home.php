...
class Home extends Secure_area 
{
	...
	function download($file_id,$unset_export_session = 0)
	{
		...
		if ($unset_export_session)
		{
			if ($this->session->userdata('recent_excel_export_file_id'))
			{
				$this->session->unset_userdata('recent_excel_export_file_id');
			}
		}
	...
	function async_inventory_updates()
	{
		...
		foreach($_SESSION['async_inventory_updates'] as $inventory_update)
		{
