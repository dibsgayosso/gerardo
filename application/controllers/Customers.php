...
class Customers extends Person_controller
{
	...
	*/
	...
	function excel_export_start($create_temp_file = 1)
	{
		$this->load->view('excel_export_start',array('export_url' => site_url('customers/excel_export/'.($create_temp_file ? 1 : 0)),'status_check_url' => site_url('customers/get_recent_export_file_url')));
	}
	...
	function excel_export($create_temp_file=0) {
