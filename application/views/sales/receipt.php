...
<div class="row">
    <!-- Top Section: Company Name and Logo -->
...
<div class="row">
    ...
    <div class="col-xs-6" style="border-right: 1px solid #000;">
        <ul class="list-unstyled">
            <li><strong><?php echo lang('common_sale_id', '', array(), TRUE); ?>:</strong> <?php echo H($sale_id); ?></li>
            <li><strong><?php echo lang('common_date', '', array(), TRUE); ?>:</strong> <?php echo H($transaction_time); ?></li>
            <?php if (!$this->config->item('remove_employee_from_receipt')) { ?>
                <li><strong><?php echo lang('common_employee', '', array(), TRUE); ?>:</strong> <?php echo H($this->config->item('remove_employee_lastname_from_receipt') ? $employee_firstname : $employee); ?></li>
            <?php } ?>
        </ul>
    </div>
            ...
            <?php } ?>
				...
				<div class="row">
					<div class="col-md-12 col-sm-12 col-xs-12">
						...
						<?php if (is_store_account_sale($cart)) { ?>
							<div class="row" style="margin-top: 30px;">
								<!-- Columna izquierda para firma -->
								<div class="col-md-6 col-sm-6">
									<div class="invoice-policy" style="text-align: center; border: 1px solid #000; padding: 20px; height: 100%;">
										<p style="font-weight: bold; margin-bottom: 40px;">Nombre de quien recibe:</p>
										<br><br><br>
										<p>___________________________________</p>
										<p>Firma:</p>
										<br>
										<p style="font-weight: bold; font-size: 20px; margin: 0;">Recibí mercancía completa y pagaré el total de esta nota</p>
									</div>
								</div>
								
								<!-- Columna derecha para la leyenda -->
