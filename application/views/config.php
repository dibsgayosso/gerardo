...
<div class="config-panel">
	...
	<?php } ?>
		...
		<div class="col-md-12 sales_info">
			<div class="panel panel-piluku">
				<div class="panel-heading">
					<a data-toggle="collapse" data-parent="#collapsePanels" href="#returns">
						<?php echo create_section(lang('common_return_info'))  ?>
					</a>
				</div>
				<div id="returns" class="panel-collapse collapse" aria-expanded="false" style="height: 0px;">
					<div class="panel-body">
					...
					<div class="panel-body">
		        		...
		        		<div class="form-group" data-keyword="<?php echo H(lang('config_keyword_woocommerce')) ?>">	
		      			...
		      			<div class="form-group" data-keyword="<?php echo H(lang('config_keyword_woocommerce')) ?>">	
							...
							<button id="woo_oauth" type="button" class="btn btn-lg btn-primary pull-right"><?php echo lang('config_connect_to_woocommerce'); ?></button>
